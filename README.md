...
| 요구사항 | 프로젝트 1 (Make) | 프로젝트 1 (n8n) | 프로젝트 2 (n8n) | 상세 |
|---|---|---|---|---|
| 실제 동작하는 워크플로우 | ✅ 09:00 스케줄 활성화 | ✅ 09:00 스케줄 활성화 | ✅ 15분 스케줄 활성화 | — |
| Trigger 1개 이상 | Schedule (매일 09:00) | Schedule (매일 09:00) | Schedule (15분) | [P1 §2](docs/project1-comparison.md) / [P2 §3.2](docs/project2-design.md) |
| Action 2개 이상 | Sheets Add a Row, Telegram, Sheets Update a Cell | Sheets Append, Telegram, Sheets Update Row | + Gemini 호출 | 〃 |
| 조건 분기 1개 이상 | Router (4경로) | Switch (3경로) + Filter | Switch (3경로) + Filter 2개 | 〃 |
| **각 분기 경로 1회 이상 실행** | 학사 16 / 공모전 10 / 기타 4 | 학사 16 / 공모전 10 / 기타 4 | 학사 16 / 공모전 10 / 기타 4 | [P1 §4.4](docs/project1-comparison.md) |
...
| 요구사항 | 충족 | 위치 |
|---|---|---|
| 서로 다른 2개 이상의 도구 | Make / n8n (Zapier 제외 사유 명시) | [P1 §1](docs/project1-comparison.md) |
| 동일한 워크플로우 구조 | 파싱 경로가 다름에도 출력 30건 완전 일치 | [P1 §4.4](docs/project1-comparison.md) |
| 최소 5개 이상의 비교 항목 | **9개** | [P1 §5](docs/project1-comparison.md) |
| 각 도구의 장단점 | | [P1 §6](docs/project1-comparison.md) |
| 어떤 상황에 적합한지 | | [P1 §7](docs/project1-comparison.md) |
| 반복 업무 1개 정의 | 3개 게시판 순회 확인 (연 18~30시간) | [P2 §1](docs/project2-design.md) |
| 도구 1개 선정 및 이유 | n8n — 프로젝트 1의 크레딧 실측이 근거 | [P2 §2](docs/project2-design.md) |
| Trigger 발생 시 자동 실행 | Schedule Trigger 15분, 실행 이력으로 확인 | [P2 §3](docs/project2-design.md) |
| 보너스 1 — AI 연동 Action | Gemini 분류 노드 추가 | [P2 §4](docs/project2-design.md) |
| 보너스 2 — 실패 알림 및 재시도 | Error Workflow + Retry On Fail | [P2 §5](docs/project2-design.md) |
